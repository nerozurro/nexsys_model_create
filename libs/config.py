...
def update_paths():
    ...
    pathDB = r'C:\Leonardo\ManchesterUniversity\Projects\Ethiopia\Development\model\database\Ethiopia_pywr_create_network_xls_V0.1.2.xlsm'
    # pathDB = r'C:\Leonardo\ManchesterUniversity\Tutorial\Test\Nile_pywr_create_network_xls_V0.1.xlsm'
